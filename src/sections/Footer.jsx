...
const Footer = () => {
    return (
        ...
        <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
            <button
                className="inline-flex items-center border-2 border-white px-6 py-3 rounded-lg bg-black-200 hover:bg-blue-600 text-gray-50"
                onClick={() => {
                    window.open('https://play.google.com/store/games?device=phone&hl=en', '_blank');
                }}
            >
            ...
            <button
                className="inline-flex items-center border-2 border-white px-5 py-3 rounded-lg bg-black-200 hover:bg-blue-600 text-gray-50"
                onClick={() => {
            ...
            >
                ...
                <div className=" text-xl contact text-center md:text-left">
                    ...
                    <div className=" mb-7 text-gray-100">
                        ...
                        <a
                            href="mailto:hamza.officaill23@gmail.com"
                    ...
                    <div className="flex items-center mt-1 space-x-3 justify-center md:justify-start">
                        <a
                            href="https://www.facebook.com/hamza.rajwara?mibextid=JRoKGi"
                            target="_blank"
                        ...
                        <a
                            href="https://www.instagram.com/hamza.officiall01?igshid=OGQ5ZDc2ODk2ZA=="
                            target="_blank"
                            rel="noopener noreferrer"
