...
import { FaFacebookF, FaTwitter, FaInstagram, FaPlay, FaAppStoreIos} from "react-icons/fa";

const Footer = () => {
    return (
        <div className="px-4 pt-16 pb-10 mx-auto sm:max-w-xl md:max-w-full md:px-24 lg:px-32 bg-secondary-txt text-white">
            <div className="grid gap-24 md:gap-40 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                <div className="sm:col-span-2 text-white">
                    <h1 className=' text-5xl '>Install Our App</h1>
                    <p className=' mt-5 text-lg mb-12'>Click the below button to install</p>
                    <div className='flex text-center md:text-left'>

                        {/* <button className="flex items-center border-2 border-white rounded-lg px-6 py-4 bg-black-200 hover:bg-yellow-600 text-white text-lg mr-4">
                            <FaPlay className="mr-4" />  Play Store
                        </button>
                        <button className="flex items-center border-2 border-white rounded-lg px-6 py-4 bg-black-200 hover:bg-yellow-600 text-white text-lg">
                            <FaAppStoreIos className="mr-4" /> App Store
                        </button> */}
                        ...
                        <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
                            <button className="inline-flex items-center border-2 border-white px-6 py-3 rounded-lg bg-black-200 hover:bg-yellow-600 text-gray-50">
                            ...
                            <button className="inline-flex items-center border-2 border-white px-5 py-3 rounded-lg bg-black-200 hover:bg-yellow-600 text-gray-50">
                ...
                <div className=" text-xl contact text-center md:text-left">
                    ...
                    <div className=" mb-7 text-gray-100">
                        ...
                        <a
                            href="mailto:sharjeelshah2700@gmail.com"
                    ...
                    <div className="flex items-center mt-1 space-x-3 justify-center md:justify-start">
                        <a
                            ...
                            className="text-background-yellow transition-all duration-300 hover:text-white hover:scale-150"
                        >
                            <FaFacebookF size={25} />
                        </a>
                        <a
