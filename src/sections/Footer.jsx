                ...
                <div className="sm:col-span-2 text-white">
                    ...
                    <div className='flex text-center md:text-left'>
                        ...
                        <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
                            <button className="inline-flex items-center border-2 border-white px-6 py-3 rounded-lg bg-black-200 hover:bg-blue-600 text-gray-50">
                            ...
                            <button className="inline-flex items-center border-2 border-white px-5 py-3 rounded-lg bg-black-200 hover:bg-blue-600 text-gray-50">
